...
function buscarDados() {
  ...
  fetch(`https://api-financas-omega.vercel.app/inicio/${periodo.mes + 1}/${periodo.ano}`, options).then(res => {
    return res.json();
  }).then(json => {
    dados = json;
    calcularReceitas();
...
function adicionarReceita() {
  ...
  if (valor && categoria && local && dia && mes && ano) {
    ...
    fetch("https://api-financas-omega.vercel.app/add/receita", options).then(res => {
...
function adicionarDespesa() {
  ...
  if (valor && categoria && local && dia && mes && ano) {
    ...
    fetch("https://api-financas-omega.vercel.app/add/despesa", options).then(() => {
...
function editar(id, tipo) {
  ...
  if (valor && categoria && local && data) {
    ...
    fetch("https://api-financas-omega.vercel.app/editar", options).then(res => {
...
function excluir(id, tipo) {
  ...
  fetch("https://api-financas-omega.vercel.app/excluir", options).then(res => {
